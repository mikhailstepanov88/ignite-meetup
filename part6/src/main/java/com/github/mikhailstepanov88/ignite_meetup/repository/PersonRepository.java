...
public class PersonRepository {
     ...
     */
    @NonNull
    public <TypeOfResult> Optional<TypeOfResult> executeInTransaction(@Nullable TransactionConcurrency concurrency,
                                                                      @Nullable TransactionIsolation isolation,
                                                                      @NonNull Supplier<Optional<TypeOfResult>> action) {
    ...
    public <TypeOfResult> Optional<TypeOfResult> executeInTransaction(@Nullable TransactionConcurrency concurrency,
        ...
        try (Transaction transaction = transactions.txStart(
            ...
            Optional<TypeOfResult> result = action.get();
            if (result.isPresent()) {
                transaction.commit();
            } else {
